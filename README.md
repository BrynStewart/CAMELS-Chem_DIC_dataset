...
This page includes the mean values for discharge, water temperature, ET/P, PET/P, pH, dissolved inorganic carbon (DIC), pCO2, DIC concentration-discharge slope values, and catchment attributes from the CAMELS-Chem database used in Stewart et al., (in preparation). The entire database will be available when the CAMELS-Chem manuscript is published (Sterle et al., in preparation).
